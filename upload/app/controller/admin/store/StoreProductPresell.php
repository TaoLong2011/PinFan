...
class StoreProductPresell extends BaseController
{
    ...
    public function lst()
    {
        ...
        $where = $this->request->params(['product_status','keyword','status','type','presell_type','mer_id','is_trader']);
    ...
    public function saveAgree()
    {
        ...
        app()->make(CacheRepository::class)->save('sys_product_presell_agree',$agree);
    ...
    public function productStatus()
    {
        ...
        foreach ($id as $item){
            queue(ChangeSpuStatusJob::class,['id' => $item,'product_type' => 2]);
        }
